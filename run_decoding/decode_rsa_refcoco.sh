...
do
  ...
  do
      ...
      python decode_captions_rsa.py --refcoco_path $refcoco_path  --refcoco_model $refcoco_model --refcoco_vocab $refcoco_vocab --out_dir $refcoco_out_dir --image_dir $image_dir --split $SPLIT --speaker_rat $RAT --beam_width $beam_width --max_len $max_len
