...
do
  ...
  do
      ...
      python decode_captions_es.py --refcoco_path $refcocog_path  --refcoco_model $refcocog_model --refcoco_vocab $refcocog_vocab --out_dir $refcocog_out_dir --image_dir $image_dir --split $SPLIT --lambda_ $LAMBDA --beam_width $beam_width --max_len $max_len
