...
do
  ...
  do
      ...
      python decode_captions_es.py --refcoco_path $refcocoplus_path  --refcoco_model $refcocoplus_model --refcoco_vocab $refcocoplus_vocab --out_dir $refcocoplus_out_dir --image_dir $image_dir --split $SPLIT --lambda_ $LAMBDA --beam_width $beam_width --max_len $max_len
